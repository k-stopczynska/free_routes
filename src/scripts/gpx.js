                ...
                reader.onload = (e) => {
                    ...
                    const gpxLayer = new L.GPX(gpxData, {
                        ...
                        Array.from(trackPoints).forEach((point) => {
                            ...
                            routePointsFromGpx.push(new L.LatLng(lat, lon));
                        });
                        if (routePointsFromGpx.length === 0) {
                            console.error("No route points found in the GPX file.");
                        } else {
                            routePointsFromGpx.forEach((latLng) => {
                            ...
                            calculateDistance(routePointsFromGpx);
                        }
                    }).addTo(this.map);
                };
